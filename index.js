    ...
    return await new Promise((resolve, reject) => {
        ...
        if(ctx.chat.type == 'private') {
            if(ctx.from.id == Number(process.env.ADMIN) || ctx.from.id == Number(process.env.ADMIN1) || ctx.from.id == Number(process.env.ADMIN2)){
                ...
                await saver.checkFile(`${document.file_unique_id}`, async(res) => {
                    //console.log(res);
                    if(res == true) {
    ...
    return await new Promise((resolve, reject) => {
        ...
        if(ctx.chat.type == 'private') {
            if(ctx.from.id == Number(process.env.ADMIN) || ctx.from.id == Number(process.env.ADMIN1) || ctx.from.id == Number(process.env.ADMIN2)){
                ...
                await saver.checkFile(`${video.file_unique_id}`, async(res) => {
                    //console.log(res);
                    if(res == true) {
                        await ctx.reply(`File already exists.`,{
                            reply_to_message_id: ctx.message.message_id
    ...
    return await new Promise((resolve, reject) => {
        ...
        if(ctx.chat.type == 'private') {
            if(ctx.from.id == Number(process.env.ADMIN) || ctx.from.id == Number(process.env.ADMIN1) || ctx.from.id == Number(process.env.ADMIN2)){
                ...
                await saver.checkFile(`${photo.file_unique_id}`, async(res) => {
                    //console.log(res);
                    if(res == true) {
                        await ctx.reply(`File already exists.`,{
                            reply_to_message_id: ctx.message.message_id
